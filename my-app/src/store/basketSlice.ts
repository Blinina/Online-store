...
export const getDataBasket = createAsyncThunk("/basket/getMyBasket", async (payload: string) => {
...
export const selectors = basketAdapter.getSelectors((state: RootState) => state.basket)
export const getBasket = (state: EmptyObject & interfaceGetBasket & PersistPartial) =>
